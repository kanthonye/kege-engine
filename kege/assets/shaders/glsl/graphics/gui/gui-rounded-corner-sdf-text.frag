...
layout(location = 6) in float texture_id;   // Texture array index
...
vec4 sampleTexture( int texr_id )
{
    ...
    switch ( texr_id )
    {
        case 0: texr = texture( _theme, text_uv ); break;
        case 1: texr = texture( _font,  text_uv ); break;
        case 2: texr = texture( _scene, text_uv ); break;
        default: texr = vec4(0.0); break;
    }
    return texr;
}
