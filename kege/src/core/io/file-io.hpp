...
namespace kege
{
    ...
    public:
        ...
        template< typename T > static kege::Ref< T > load( const kege::string& filename )
        {
            kege::string full_filename = _virdir->fetch( filename );
            if ( full_filename )
            {
                return T::load( _virdir->fetch( full_filename ) );
            }
            return nullptr;
        }
         ...
         */
        static kege::VirtualDirectory& virdir();
        /**
         * @brief Saves a file.
         ...
         */
        static bool initialize( const kege::string& rootpath );
    ...
    private:
        ...
        static kege::Ref< kege::VirtualDirectory > _virdir;
