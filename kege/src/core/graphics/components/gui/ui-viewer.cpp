...
//    }
//
//    bool Viewer::initialize( kege::AppWindow* window, kege::GraphicsDevice* graphics, kege::AssetManager* asset_manager, ref::Font font )
//    {
...
//
//        const kege::ShaderPipelineSetDesc shader_pipeline_resource_layout_desc =
//        {
//            ShaderSetDesc
//            {
...
//        };
//
//        _resource_binder = _graphics->createShaderResourceBinder
//        (
//            shader_pipeline_resource_layout_desc
//        );
//
...
//            });
//            uint64_t handle = _asset_manager->add< ref::Image >( "default", default_image );
//            image = _asset_manager->get< ref::Image >( handle );
//        }
//        
//        ref::Sampler* sampler = asset_manager->fetch< ref::Sampler >( "linear" );
//        if( sampler )
//        {
...
//            });
//            uint64_t handle = _asset_manager->add< ref::Sampler >( "linear", linear_sampler );
//            sampler = _asset_manager->get< ref::Sampler >( handle );
//        }
//
//        _resource_binder->setBuffer(0, 0, 0, createBuffer());
//        _resource_binder->setImage(1, 0, 0, {kege::ImageBindInfo{ .image = *image, .sampler = *sampler, .layout = ImageLayout::ShaderRead }});
//        _resource_binder->setImage(1, 0, 0, {font->getImageBindInfo()});
//        _resource_binder->setImage(1, 0, 0, {kege::ImageBindInfo{ .image = *image, .sampler = *sampler, .layout = ImageLayout::ShaderRead }});
//
...
//    {
//        _resource_binder->setImage( 3, 0, 0, kege::ImageBindings{info} );
//    }
//
//    void Viewer::setThemeImage( const kege::ImageBindInfo& info, int frame )
//    {
//        _resource_binder->setImage( 2, 0, 0, kege::ImageBindings{info}  );
//    }
//
//    void Viewer::setFontImage( const kege::ImageBindInfo& info, int frame )
//    {
//        _resource_binder->setImage( 1, 0, 0, kege::ImageBindings{info}  );
//    }
//
