...
//         */
//        bool initialize( kege::AppWindow* window, kege::GraphicsDevice* graphics, kege::AssetManager* asset_manager, ref::Font font );
//
...
//        ref::Font _font;
//
//        ref::ShaderResourceBinder _resource_binder;
...
//
//        kege::PushConstantBlock _push_constant;
//        ui::Extent _fbo_size;
