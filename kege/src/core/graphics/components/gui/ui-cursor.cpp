...
//    }
    ...
    uint32_t Cursor::getCursorColor()const
    {
        return _color_cursor;
    }

    bool Cursor::isSelectionActive()const
    {
    ...
    Cursor::Cursor( kege::GUI* gui )
    :   _gui( gui )
    ,   _keyboard( gui->getInputManager()->getKeyboard() )
    ,   _mouse( gui->getInputManager()->getMouse() )
    ,   _position(0)
    ,   _timer(0.0)
