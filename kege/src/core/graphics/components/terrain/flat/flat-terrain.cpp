...
//TODO: fix        createMeshPrimitive( _graphics, _primative, _draw_commands );
...
//        _layers.clear();
    ...
    void createMeshPrimitive( GraphicsDevice* graphics, kege::Ref< kege::StandardMesh >& primative, std::vector< IndexDrawCommand >& draw_commands )
    {
...
//TODO: fix        primative->index_buffer = graphics->createBuffer
//        ({
