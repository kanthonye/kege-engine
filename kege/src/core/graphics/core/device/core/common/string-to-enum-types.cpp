...
//    }
    ...
    Format stringToFormat( const std::string& name )
    {
        ...
        if ( types.empty() )
        {
            ...
            types[ "r_f16" ] = Format::r_f16;
            types[ "rg_f16" ] = Format::rg_f16;
            types[ "rgb_f16" ] = Format::rgb_f16;
            types[ "rgba_f16" ] = Format::rgba_f16;
            ...
            types[ "r_f32" ] = Format::r_f32;
            types[ "rg_f32" ] = Format::rg_f32;
            types[ "rgb_f32" ] = Format::rgb_f32;
            types[ "rgba_f32" ] = Format::rgba_f32;
            ...
            types[ "r_f64" ] = Format::r_f64;
            types[ "rg_f64" ] = Format::rg_f64;
            types[ "rgb_f46" ] = Format::rgb_f64;
            types[ "rgba_f64" ] = Format::rgba_f64;
            ...
            types[ "r_u16_norm" ] = Format::r_u16_norm;
            types[ "rg_u16_norm" ] = Format::rg_u16_norm;
            types[ "rgb_u16_norm" ] = Format::rgb_u16_norm;
            types[ "rgba_u16_norm" ] = Format::rgba_u16_norm;
