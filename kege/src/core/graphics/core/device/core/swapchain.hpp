...
namespace kege::cref
{
    typedef kege::Ref< const kege::Swapchain > Swapchain;
}
...
namespace kege{
    ...
    public:
        ...
        //virtual const ref::Semaphore& getImageAvailableSemaphore( uint32_t frame_index )const = 0;
        //virtual const ref::Semaphore& getRenderFinishSemaphore( uint32_t frame_index )const = 0;
        virtual kege::Result acquireNextImage() = 0;
