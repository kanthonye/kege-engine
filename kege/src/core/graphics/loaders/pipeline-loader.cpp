...
namespace kege{
    ...
    )    
    {
        ...
        return createPipelineFromFile( graphics, json, path );
    }

    kege::PipelineHandle PipelineLoader::createPipelineFromFile
    (
        kege::Graphics* graphics,
        kege::Json json,
        const std::string& path
    )
    {
        ...
        createPipelineLayout( graphics, &info, info.debug_name, json );
