...
namespace kege{
    ...
    MemberType stringToMemberType( const char* str )
    {
        static std::map< std::string, kege::MemberType > table;
        if( table.empty() )
        {
            table[ "sint" ] = kege::MemberType::Sint;
            table[ "uint" ] = kege::MemberType::Uint;
            table[ "vec2" ] = kege::MemberType::Vec2;
            table[ "vec3" ] = kege::MemberType::Vec3;
            table[ "vec4" ] = kege::MemberType::Vec4;
            table[ "mat2" ] = kege::MemberType::Mat2;
            table[ "mat3" ] = kege::MemberType::Mat3;
            table[ "mat4" ] = kege::MemberType::Mat4;
        }
        ...
        Log::error << "invalid MemberType -> " << str <<Log::nl;
        return kege::MemberType::Sint;
    }
...
//    }
    ...
    kege::Format stringToFormat( const std::string& type )
    {
        ...
        kege::Log::error << "invalid format" << kege::Log::nl;
        return {};
    }
}
