...
namespace kege::vk{
    ...
    public:
        ...
        virtual const vk::PhysicalDevice* vk() const { return this; }
        virtual vk::PhysicalDevice* vk() { return this; }
    ...
    private:
        ...
        friend List< vk::PhysicalDevice >;
        vk::PhysicalDevice* prev;
        vk::PhysicalDevice* next;
    };
