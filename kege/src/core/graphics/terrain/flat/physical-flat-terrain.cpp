...
#include "physical-flat-terrain.hpp"

namespace kege{

    void PhysicalFlatTerrain::render( kege::CommandBuffer& command_buffer )
    {
    ...
    void PhysicalFlatTerrain::update( const dvec3& eye )
    {
    ...
    bool PhysicalFlatTerrain::initialize( Ref< FlatTerrainRenderer > renderer )
    {
        if ( _init )
        {
            return true;
    ...
    void PhysicalFlatTerrain::insert( const sint2& coord, FlatTerrainTile* tile )
    {
    ...
    PhysicalFlatTerrain::PhysicalFlatTerrain( kege::Terrain* terrain )
    :   _renderer( this )
    {}
