...
namespace kege{
    ...
    {
//        ecs::Entity camera_entity = getScene()->getCameraEntity();
...
//    }
    ...
    UpdateSceneCamera::UpdateSceneCamera( kege::ECS* ecs )
    :   kege::ecs::System( ecs, "UpdateSceneCamera", REQUIRE_UPDATE  )
    {
        //_signature = createEntitySignature< Camera, kege::Transform >();
    }

    KEGE_REGISTER_ENTITY_SYSTEM( UpdateSceneCamera, "UpdateSceneCamera" );
}
