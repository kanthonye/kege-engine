...
//            }
    ...
    )
    {
        ...
        {
            BindSetDescs& bind_sets = create_info.shader_layout.bind_sets;
            {
                ...
                for ( int set_index = 0; set_index < pipeline_layout_data.set_layouts.size(); ++set_index )
                {
                    ...
                    BindSetDesc& set = bind_sets[ set_index ];
            ...
            create_info.shader_layout.push_blocks.resize( pipeline_layout_data.push_layouts.size() );
            for (int i = 0; i < pipeline_layout_data.push_layouts.size(); ++i)
            {
                PushBlockDesc& block = create_info.shader_layout.push_blocks[i];
