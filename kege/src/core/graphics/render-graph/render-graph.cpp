...
//        }
    ...
    const ImageDefn* RenderGraph::getImageDefn( const std::string& name )
    {
        ...
        if ( i == _image_resource_map.end() ) return nullptr;
        return &_image_definitions[ i->second.index ];
    }
    ...
    const BufferDefn* RenderGraph::getBufferDefn( const std::string& name )
    {
        auto i = _buffer_resource_map.find( name );
        if ( i == _buffer_resource_map.end() ) return nullptr;
        return &_buffer_definitions[ i->second.index ];
    }
