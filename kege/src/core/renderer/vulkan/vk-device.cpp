...
namespace kege::vk{
    ...
    kege::PipelineHandle Device::createGraphicsPipeline( const kege::GraphicsPipelineDesc& desc )
    {
        ...
        // 10. Pipeline Layout
        graphics_create.layout = layout->layout;
...
//    }
//
//    const DescriptorSetLayout* Device::getDescriptorSetLayout( kege::UniformSetLayout handle ) const
//    {
//        return _pipeline_layout_manager.getPhysicalDescriptorSetLayout( handle );
//    }
//
//    void Device::destroyUniformSetLayout( kege::UniformSetLayout handle )
//    {
//        _pipeline_layout_manager.destroyUniformSetLayout( handle );
//    }
    ...
    size_t Device::bufferSize( const BufferHandle& handle )
    {
        ...
        ? 0 : _buffers.get( handle.id )->desc.size;
    }
