...
//        std::vector< UniformDesc > bindings;
//
...
//
//        const vk::DescriptorSet* getDescriptorSet( const kege::ShaderResource& handle )const;
//        vk::DescriptorSet* getDescriptorSet( const kege::ShaderResource& handle );
//
//
...
//        );
//
//        bool allocateDescriptors( const std::vector< kege::UniformDesc >& bindings, int frames_in_flight, ShaderResource* handles );
//        bool allocateDescriptors( const UniformSetLayout& layout, int frames_in_flight, ShaderResource* handles );
//        
//        /**
...
//
//        kege::ShaderResource allocateDescriptorSet( const std::vector< kege::UniformDesc >& bindings );
//
//        /**
...
//         */
//        kege::ShaderResource allocateDescriptorSet( kege::UniformSetLayout layout_handle );
//
//        /**
...
//         */
//        kege::UniformSetLayout createDescriptorSetLayout( const std::vector< kege::UniformDesc >& bindings );
//
//        /**
...
//         */
//        const vk::DescriptorSetLayout* getDescriptorSetLayout( const kege::UniformSetLayout& handle )const;
//        vk::DescriptorSetLayout* getDescriptorSetLayout( const kege::UniformSetLayout& handle );
//
//        /**
//         * @brief Get a descriptor-set-layout
//         *
...
//         */
//        kege::UniformSetLayout getDescriptorSetLayout( const std::vector< kege::UniformDesc >& bindings, bool create );
//
//        /**
...
//         */
//        void destroyUniformSetLayout( kege::UniformSetLayout handle );
//
//        /**
...
//         */
//        void freeDescriptorSet( kege::ShaderResource handle );
//
