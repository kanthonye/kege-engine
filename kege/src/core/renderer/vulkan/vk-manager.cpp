...
namespace kege::vk{
    ...
    VkDevice Manager::createDevice( vk::PhysicalDevice* physical_device, VkSurfaceKHR surface, QueueFamilyIndices& queue_family_indices )
    {
    ...
    void Manager::copyBufferToTexture
    (
    ...
    void Manager::destroySurface( VkSurfaceKHR surface, const VkAllocationCallbacks *allocator )
    {
