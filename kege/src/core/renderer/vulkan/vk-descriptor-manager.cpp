...
//namespace kege::vk{
//
//    const DescriptorSet* DescriptorManager::getDescriptorSet( const kege::ShaderResource& handle )const
//    {
//        return _descriptor_sets.get( handle.id );
//    }
//
//    DescriptorSet* DescriptorManager::getDescriptorSet( const kege::ShaderResource& handle )
//    {
//        return _descriptor_sets.get( handle.id );
//    }
//
...
//    (
//        Device* device,
//        const kege::Uniform& resource_binding,
//        std::vector<VkDescriptorImageInfo>& image_infos,
//        VkWriteDescriptorSet* descriptor_write
//    )
//    {
//        int starting_index = static_cast< uint32_t >( image_infos.size() );
//        for(const auto& info : resource_binding.image_info)
//        {
//            const Sampler* sampler = device->getSampler( info.sampler );
//            const Image* image = device->getImage( info.image );
...
//        descriptor_write->dstBinding = resource_binding.binding;
//        descriptor_write->dstArrayElement = 0;//resource_binding.array_element;
//        descriptor_write->descriptorType = convertDescriptorType( resource_binding.descriptor_type );
//        descriptor_write->descriptorCount = static_cast< uint32_t >( resource_binding.image_info.size() );
...
//    )
//    {
//        int starting_index = static_cast< uint32_t >( buffer_infos.size() );
//        for( const auto& info : resource_binding.buffer_info )
//        {
//            const Buffer* buffer = device->getBuffer( info.buffer );
//            if (buffer != nullptr)
//            {
...
//        descriptor_write->dstArrayElement = 0;//resource_binding.array_element;
//        descriptor_write->descriptorType = convertDescriptorType(resource_binding.descriptor_type);
//        descriptor_write->descriptorCount = static_cast< uint32_t >( resource_binding.buffer_info.size() );
//        descriptor_write->pBufferInfo = &buffer_infos[ starting_index ];
//        return true;
//    }
//
//    bool DescriptorManager::updateDescriptorSets
//    (
//        kege::ShaderResource& set,
//        const std::vector< kege::Uniform >& bindings
//    )
//    {
...
//
//        DescriptorSet* descriptor = _descriptor_sets.get( set.id );
...
//
//        //int starting_index;
//        for (const kege::Uniform& resource_binding : bindings )
//        {
//            VkWriteDescriptorSet descriptor_write = {};
//            descriptor_write.sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
...
//    }
//
//    bool DescriptorManager::allocateDescriptors
//    (
...
//    )
//    {
//        kege::UniformSetLayout layout = getDescriptorSetLayout( bindings, true );
//        return allocateDescriptors( layout, frames_in_flight, handles );
//    }
//    bool DescriptorManager::allocateDescriptors( const UniformSetLayout& layout, int frames_in_flight, ShaderResource* handles )
//    {
//        if ( layout.id < 0 )
//        {
...
//        vk::DescriptorSetLayout* dsl = getDescriptorSetLayout( layout );
//        /**
...
//            for ( const kege::UniformDesc& binding : dsl->bindings )
//            {
...
//         */
//        std::vector< VkDescriptorSetLayout > descriptor_set_layouts( frames_in_flight, dsl->layout );
//        /**
...
//        VkResult result;
//        
//        VkDescriptorSet descriptor_set[ frames_in_flight ];
...
//        {
//            /**
//             7. With the vk descriptor set allocated. store its info into a new descriptor set object.
//             */
//            handles[i].id = _descriptor_sets.gen();
//
//            vk::DescriptorSet* set = _descriptor_sets.get( handles[i].id );
//            set->set = descriptor_set[i];
//            set->pool_id = pool->id;
//            set->layout = layout;
//        }
//        
...
//    }
//
//    kege::ShaderResource DescriptorManager::allocateDescriptorSet( const std::vector< kege::UniformDesc >& bindings )
//    {
//        kege::UniformSetLayout layout_handle = getDescriptorSetLayout( bindings, true );
//        return allocateDescriptorSet( layout_handle );
//    }
//
//    kege::ShaderResource DescriptorManager::allocateDescriptorSet( kege::UniformSetLayout layout_handle )
//    {
...
//    }
//
//    kege::UniformSetLayout DescriptorManager::createDescriptorSetLayout( const std::vector< kege::UniformDesc >& bindings )
//    {
...
//        for ( const kege::UniformDesc& binding : bindings )
//        {
...
//            Log::info << dsl->name << " [binding_location: " <<dsl->binding_location <<"] [ binding_index: " << binding_index <<"]" << Log::nl;
//            binding_index += 1;
//        }
//
//        /**
...
//    }
//
//    const vk::DescriptorSetLayout* DescriptorManager::getDescriptorSetLayout( const kege::UniformSetLayout& handle )const
//    {
//        return _descriptor_set_layouts.get( handle.id );
//    }
//
//    vk::DescriptorSetLayout* DescriptorManager::getDescriptorSetLayout( const kege::UniformSetLayout& handle )
//    {
//        return _descriptor_set_layouts.get( handle.id );
//    }
//
//    kege::UniformSetLayout DescriptorManager::getDescriptorSetLayout( const std::vector< kege::UniformDesc >& bindings, bool create )
//    {
//        auto i = _descriptor_set_layout_cache.find( bindings );
//        if ( i != _descriptor_set_layout_cache.end() )
//        {
...
//    }
//
//    void DescriptorManager::destroyUniformSetLayout(kege::UniformSetLayout handle)
//    {
//        if ( _descriptor_set_layouts.get( handle.id ) != nullptr )
//        {
//            vk::DescriptorSetLayout* dsl = _descriptor_set_layouts.get( handle.id );
//            _device->destroyUniformSetLayout( dsl->layout, nullptr );
...
//    }
//
//    void DescriptorManager::freeDescriptorSet(kege::ShaderResource handle)
//    {
//        if ( _device == VK_NULL_HANDLE || handle.id == 0) return;
//        std::lock_guard<std::mutex> lock(_resource_mutex);
//
...
//            {
//                _device->destroyUniformSetLayout( _descriptor_set_layouts.get( i )->layout, nullptr );
//            };
//        }
