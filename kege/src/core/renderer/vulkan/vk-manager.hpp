...
namespace kege::vk{
    ...
    public:
        ...
        VkDevice createDevice( vk::PhysicalDevice* physical_device, VkSurfaceKHR surface, QueueFamilyIndices& queue_family_indices );
        ...
        void destroyImageView( VkImage& image_view );
