...
#include "friction-solver.hpp"

namespace kege{

//    void FrictionSolver::resolveImpulse( double time_step, CollisionRegistry& collision_manager )
//    {
...
//    void ContactImpulseSolver::applyAngularImpulse( Rigidbody* object, const vec3& r, const vec3 impulse )
//    {
//        object->angular.velocity += object->angular.inertia_inverse * cross( r, impulse );
//    }
//
//    void ContactImpulseSolver::applyLinearImpulse( Rigidbody* object, const vec3 impulse )
//    {
//        object->linear.velocity += object->linear.invmass * impulse;
//    }
...
//        state->shape[0] = collision->objects[0]->collider->shape;
//        state->shape[1] = collision->objects[1]->collider->shape;
//        /**
...
//        state->j /= float( state->contact_count );
...
//        {
//            resolveImpulse( dms, collision_manager );
//        }
//    }
//
