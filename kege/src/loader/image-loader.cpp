...
namespace kege{
    ...
    ImageHandle ImageLoader::load( Graphics* graphics, const std::string& filename )
    {
        ...
        //CommandBuffer* cmd = graphics->createCommandBuffer( QueueType::Transfer );
        //cmd->copyBufferToTexture( <#BufferHandle src_buffer#>, <#ImageHandle dst_texture#>, <#const std::vector<BufferTextureCopyRegion> &regions#> )
