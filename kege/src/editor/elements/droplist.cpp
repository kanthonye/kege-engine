...
namespace kege{ class Element; }
namespace kege::ref{ typedef kege::Ref< kege::Element > Element; }

namespace kege{

    struct Element : public kege::RefCounter
    {
        virtual void update( ui::Layout& layout ) = 0;
        virtual ~Element(){}
    };
}
...
namespace kege{
    ...
    struct Dropdown : public kege::Element
    {
        void update( ui::Layout& layout );
    };
}
